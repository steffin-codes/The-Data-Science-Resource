...
# TODO: streamlit playground DO NOT PUBLISH!!!
# https://raw.githubusercontent.com/epogrebnyak/streamlit-demo/main/streamlit_app.py
def app():
    import streamlit as st
    import numpy as np
    import pandas as pd
    ...
    st.sidebar.title("This is sidebar title from template page")
